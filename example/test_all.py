...
def main():
    ...
    save(jax.jit(viewax.rotate)(img, 30), "rotate.jpg")
    ...
    # cutout_fn = viewax.masks.cutout((64, 64))
    # cutout = viewax.blend_image(rng, img, jnp.full_like(img, 128), cutout_fn)
    # save(cutout, "cutout.jpg")

    # cow_fn = viewax.masks.cowout()
    # cowout = viewax.blend_image(rng, img, jnp.full_like(img, 128), cow_fn)
    # save(cowout, "cowout.jpg")
